...
public class MyHttpHandler implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) {
        try {
            ...
            responseText.append("Request head:").append(getRequestHeader(httpExchange));
    ...
    private String getRequestHeader(HttpExchange httpExchange) {
        ...
        for (Map.Entry<String, List<String>> entry : headers.entrySet()) {
            strret +=entry.getKey() + ":" + entry.getValue().toString() + "<br/>";
...
//                .collect(Collectors.joining("<br/>"));
    ...
    private void handleResponse(HttpExchange httpExchange, String responsetext) throws Exception {
        ...
        responseContent.append("<html>")
                .append("<body>")
                .append(new String(responsetext.getBytes("utf-8"),"utf-8"))
                .append("</body>")
                .append("</html>");
